...
<html lang="en">
  ...
  <body>
    <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        ...
        <a class="btn btn-tertiary" href="../dashboardMember.php">Dashboard</a><!----TOMBOL UNTUK KEMBALI KE DASHBOARD AWAL--->
      </div>
    </nav>
   <!----------------DETAIL BUKU---------------------> 
  <div class="p-4 mt-5">
  ...
  <!------TOMBOL PINJAM DAN BATAL------------->
  <div class="card-body">
    <a href="daftarBuku.php" class="btn btn-danger">Batal</a><!----TOMBOL BATAL--->
     <a href="../formPeminjaman/pinjamBuku.php?id=<?= $item["id_buku"]; ?>" class="btn btn-success">Pinjam</a><!----TOMBOL PINJAM-->
     </div>
    </div>
   </div>
  </div>
