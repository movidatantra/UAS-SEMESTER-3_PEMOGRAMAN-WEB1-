...
if(!isset($_SESSION["signIn"]) ) {
  header("Location: ../sign/admin/sign_in.php");//keseluruhan script ini berfungsi untuk memeriksa apakah pengguna sudah masuk (sign in) atau belum. 
  //Jika sudah masuk, maka halaman akan diarahkan ke dashboardAdmin.php di dalam direktori yang sesuai.
  exit;
}
...
<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
     ...
     <title>Admin Dashboard</title><!--judul pada tab -->
  </head>
  <body>
    ...
    <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        ...
        <div class="dropdown"><!---biar dropdown-->
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard SmartLibrary</div>
